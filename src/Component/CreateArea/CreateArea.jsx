    ...
    return(
        <div className={styles.createAreaMainDiv}>
            <div className={styles.createArea}>
                <input name="title" onChange={handleChange} value={note.title} placeholder='Title' className={styles.title}/>
                <textarea name="content" value={note.content} placeholder="Take a Note" className={styles.textArea} onChange={handleChange}/>
